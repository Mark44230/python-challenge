...
print('Greatest Increase in Profits: ', max_date, ' (', '${:,.0f}'.format(max_change), ')')
print('Greatest Decrease in Profits: ', min_date, ' (', '${:,.0f}'.format(min_change), ')')
...
with open(bud_path, 'a') as f:
    ...
    print('Greatest Increase in Profits: ', max_date, ' (', '${:,.0f}'.format(max_change), ')', file=f)
    print('Greatest Decrease in Profits: ', min_date, ' (', '${:,.0f}'.format(min_change), ')', file=f)
